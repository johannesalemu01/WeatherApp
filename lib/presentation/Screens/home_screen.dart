  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return currentWeather.when(
      data: (weatherData) {
        ...
        final int condition = weatherData['current']['temp_c'].round();
        final backgroundImage = Constants().getBackgroundImage(condition);
        return Container(
                          ...
                          showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                title: Text("Error"),
                                content:
                                    Text("Error while accessing location: $e"),
                                actions: [
                                  TextButton(
                                    onPressed: () {
                                      Navigator.of(context).pop();
...
class _WeatherDisplayState extends ConsumerState<WeatherDisplay> {
  ...
  Widget build(BuildContext context) {
    try {
      ...
      final conditionWords = condition.split(' ');
      final String firstWord =
          conditionWords.isNotEmpty ? conditionWords[0] : '';
      final String secondWord =
          conditionWords.length > 1 ? conditionWords[1] : '';
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          Lottie.asset(
                              Constants().getWeatherAnimation(condition),
                              height: 70),
                          SizedBox(
                            height: 10,
                          ),
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                          children: () {
                            ...
                            var hourlyData =
                                forecastDayData[0]['hour'] as List?;
